...
/*================================================
 * 画笔颜色定义（RGB565格式，16位色）
 *
 * RGB565编码：高5位红色，中6位绿色，低5位蓝色
 *================================================*/

#define WHITE         	 0xFFFF /* 纯白色 */
#define BLACK         	 0x0000 /* 纯黑色 */
#define BLUE           	 0x001F /* 纯蓝色 */
#define BRED             0XF81F /* 蓝红色 */
#define GRED 			       0XFFE0 /* 绿红色 */
#define GBLUE			       0X07FF /* 绿蓝色 */
#define RED           	 0xF800 /* 纯红色 */
#define MAGENTA       	 0xF81F /* 洋红色 */
#define GREEN         	 0x07E0 /* 纯绿色 */
#define CYAN          	 0x7FFF /* 青色 */
#define YELLOW        	 0xFFE0 /* 纯黄色 */
